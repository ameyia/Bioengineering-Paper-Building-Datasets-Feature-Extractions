...
- `final_negatives.tsv`
- `Code-folder/`
- `external_validation_no_overlap_rerun/combined_external_validation_manifest.tsv`
...
- `external_validation_no_overlap_rerun/internal_metrics_by_seed.tsv`
- `external_validation_no_overlap_rerun/internal_metrics_summary_ci.tsv`
- `external_validation_no_overlap_rerun/combined_external_predictions_by_seed.tsv`
- `external_validation_no_overlap_rerun/combined_external_summary_ci.tsv`
...
- `external_validation_proxy_no_overlap/`
...
- `shap_outputs/`
- `shap_outputs_high_quality/`
- `stable_shap_results/`
- `shap_pcp_aac/`
- `shap_pcp_aac_ctd/`
- `shap_pcp_aac_ctd_dpc/`
...
Validation figures are stored in `outputs/validation_graphs/`. PNG files are useful
