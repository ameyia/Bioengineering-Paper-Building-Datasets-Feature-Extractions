...
```bash
python train_thrombin_models.py --input data/processed/baseline/pcp_aac_ctd_dpc.tsv --n-iter 30
```

You can run the same command for each feature set:

```bash
python train_thrombin_models.py --input data/processed/baseline/pcp_aac.tsv --output-json results_pcp_aac.json
python train_thrombin_models.py --input data/processed/baseline/pcp_aac_ctd.tsv --output-json results_pcp_aac_ctd.json
python train_thrombin_models.py --input data/processed/baseline/pcp_aac_ctd_dpc.tsv --output-json results_pcp_aac_ctd_dpc.json
```
