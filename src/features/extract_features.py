...
def main():
    ...
    parser.add_argument("--output-json", default="results/baseline/model_comparison_results.json")
    parser.add_argument("--output-model", default="results/models/best_model.pkl")
