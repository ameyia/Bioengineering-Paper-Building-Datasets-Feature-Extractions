...
def main() -> None:
    ...
    parser.add_argument("--s1-positive-fasta", default="data/raw/TableS1PositiveProteins.fasta")
    parser.add_argument("--negative-tsv", default="data/raw/final_negatives.tsv")
    parser.add_argument("--proxy-ready-tsv", default="data/raw/proxy_peptides_model_ready.tsv")
    parser.add_argument("--min-length", type=int, default=5)
    parser.add_argument("--output-prefix", default="data/processed/proxy/s1_proxy_no_overlap")
