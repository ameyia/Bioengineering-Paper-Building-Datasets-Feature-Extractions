...
def main():
    ...
    parser.add_argument("--table", default="data/processed/baseline/pcp_aac_ctd_dpc.tsv")
    ...
    parser.add_argument("--out", default="results/figures/confusion_matrices/confusion_matrix_pcp_aac_ctd_dpc_seed0.png")
