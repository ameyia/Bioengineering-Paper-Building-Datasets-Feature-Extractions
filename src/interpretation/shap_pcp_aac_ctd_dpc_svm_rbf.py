...
# SETTINGS
# -----------------------------
DATA_PATH = "data/processed/baseline/pcp_aac_ctd_dpc.tsv"
MODEL_PATH = "results/models/pcp_aac_ctd_dpc/svm_rbf.pkl"
OUTPUT_DIR = Path("results/interpretability/shap_single_outputs/pcp_aac_ctd_dpc_svm_rbf")
BACKGROUND_SIZE = 40
EXPLAIN_SIZE = 30
TOP_N = 20
RANDOM_STATE = 42
