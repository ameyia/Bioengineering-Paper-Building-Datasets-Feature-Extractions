...
# SETTINGS
# -----------------------------
DATA_PATH = "data/processed/baseline/pcp_aac.tsv"
MODEL_PATH = "results/models/pcp_aac/knn.pkl"
OUTPUT_DIR = Path("results/interpretability/shap_single_outputs/pcp_aac_knn")
BACKGROUND_SIZE = 60
EXPLAIN_SIZE = 40
TOP_N = 20
RANDOM_STATE = 42
